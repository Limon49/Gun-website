...
<nav id="nav" class="w3-bar w3-red" runat="server" style="position:fixed;top:58px; left: 0px;border:2px solid #cc0000">
    ...
    <a id="A3" href="/CustomerCare.aspx#" class="w3-bar-item w3-button w3-left w3-hover-gray" runat="server">Recharge</a>
    <a id="A4" href="/Packages.aspx" class="w3-bar-item w3-button w3-left w3-hover-gray" runat="server">Packages</a>
